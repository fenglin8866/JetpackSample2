...
package com.xxh.jetpacksample.lifecycle.example.persistence.ui;
...
import com.xxh.jetpacksample.databinding.ListFragmentBinding;
import com.xxh.jetpacksample.lifecycle.example.persistence.db.entity.ProductEntity;
import com.xxh.jetpacksample.lifecycle.example.persistence.viewmodel.ProductListViewModel;
...
public class ProductListFragment extends Fragment {
    ...
    private final ProductClickCallback mProductClickCallback = product -> {
        if (getLifecycle().getCurrentState().isAtLeast(Lifecycle.State.STARTED)) {
            ((PersistenceActivity) requireActivity()).show(product);
        }
    };
}
